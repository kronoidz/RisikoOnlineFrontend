...
for continent in data:
  ...
  print(S(4) +  f'<!-- {continent.upper()} [{len(territories)}] -->\n')
  print(S(4) + f'<g class="continent" id="{continent}">\n')
